...
export const Quotes: Quote[] = [
  {
    id: "1",
    text: "Continuing to do the same thing over and over again and expecting a different result is the definition of insanity",
  ...
  {
    id: "52",
    text: "You must think small to accomplish big things.",
  },
  {
    id: "53",
    text: "Nothing can be done without faith and confidence.",
  },
  {
    id: "54",
  ...
  {
    id: "55",
    text: "Every day is an opportunity.",
  },
  {
    id: "56",
    text: "ou do difficult things.",
  },
  {
    id: "57",
  ...
  {
    id: "62",
    text: "What you give energy towards will manifest in your life.",
  },
];
