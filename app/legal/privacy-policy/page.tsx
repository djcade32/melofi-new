  ...
  return (
    <div className="legalDoc__container">
      ...
      <ul>
        <li>
          <p>
            Account Registration: Email address, first name, last name, username, and password (if
            applicable)
          </p>
        </li>
        <li>
          <p>
            Subscription & Payments (if applicable): Payment details are processed through a
            third-party provider and are not stored by Melofi
          </p>
        </li>
        <li>
          <p>Usage Data</p>
      ...
      <p>
        Melofi uses IndexedDB to store app-related data locally on your device for a better
        experience. This data includes:
      </p>
      <ul>
        <li>
          <p>User preferences (e.g., themes, widget settings)</p>
        </li>
        <li>
          <p>Notes, focus statistics, and music history</p>
        </li>
        <li>
          <p>Cached Google Calendar data (for performance optimization)</p>
        </li>
        <li>
          <p>This data remains on your device and is not synced with our servers.</p>
        </li>
      </ul>
