...
export default function TermsAndConditions() {
  return (
    <div className="legalDoc__container">
      <h1>Terms and Conditions</h1>
      <h2>Welcome to Melofi</h2>
      <p>
        ...
        Melofi relationship with you in relation to this website. If you disagree with any part of
        these terms and conditions, please do not use our website. The term ‘Melofi’ or ‘us’ or ‘we’
      ...
      <p>
        ...
        with sounds by interacting with original artworks and enjoy our productivity suite of tools.
      </p>
      ...
      <p>
        Melofi provides the Site on an “as is” basis and makes no representations whatsoever about
        any other web site which you may access through the Site or which may link to this Site.
        When you access a site outside the Site, please understand that it is independent from the
        Site and that Melofi has no control over the content on that web site. In addition, a link
        to the Site does not mean that Melofi endorses or accepts any responsibility for the
      ...
      <ol>
        ...
        <li style={{ fontWeight: "bold" }}>
          <p>
            howsoever arising as, a result of you downloading files from the Site or that we include
            links to; and,
          </p>
        </li>
        <li style={{ fontWeight: "bold" }}>
      ...
      <p>For any assistance or clarification kindly reach out to us via:</p>
